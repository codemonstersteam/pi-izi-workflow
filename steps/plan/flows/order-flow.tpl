...
«<сущность> (черновик создания)» и «<сущность> (сохранён, version+1)». Сущность — ИЗ ТВОЕГО дерева и
твоего требования; имена из примеров роли в ответ не переписываются.
