...
(чтение карты — работа шага 6, и он её МЕРЯЕТ, а не индексирует: выше потолка ≈306 узлов полоса
встаёт с числом байт, `docs/intake.md` §3), не чинит части и не переспрашивает скаутов.
