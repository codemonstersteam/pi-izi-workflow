...
Граф шага 5 обязан ответить на четыре вопроса: **как тестировать**, **как менять**, **как выключают**
(механизм тоглов) и **как здесь ветвятся** (соглашение об именах). Живой факт: в квaркус-проекте
